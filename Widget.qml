...
Panel {
    ...
    readonly property var accents: ["#89b4fa", "#cba6f7", "#f9e2af", "#94e2d5", "#a6e3a1", "#fab387"]
    ...
    function acceptReport(text) {
        try {
            ...
            if (value !== null && (!Array.isArray(value.Breakdown) || value.Breakdown.length !== 6 || typeof value.Score !== "number"))
    ...
    implicitWidth: barLabel.implicitWidth + 18
    ...
    Text {
        ...
        color: root.opened || trigger.containsMouse ? Color.accent : root.barForeground
    ...
    Process {
        id: saved
        command: ["python3", root.script, "--latest-json"]
    ...
    KeyboardPanel {
        ...
        contentHeight: popup.fittedContentHeight(contentColumn.implicitHeight, 840)
        ...
        FocusScope {
            ...
            Keys.onUpPressed: root.selected = (root.selected + 3) % 6
            Keys.onDownPressed: root.selected = (root.selected + 3) % 6
            Controls.ScrollView {
                anchors.fill: parent
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                Layout.fillWidth: true
                                spacing: 5
                                Label { Layout.fillWidth: true; text: root.report ? root.report.Computer : "Ready when you are"; font.pixelSize: 18; font.bold: true }
                                ...
                                Label { Layout.fillWidth: true; text: root.busy ? "Taking a look under the hood…" : "Provisional · automatic ceiling 95"; font.pixelSize: 11; opacity: 0.65 }
                            }
                        }
                    }
                    Label {
                        Layout.fillWidth: true
                        visible: !!root.report && (root.report.Coverage < 100 || root.report.Inventory.Virtualized || root.report.Status.indexOf("Not a standard") === 0 || root.report.Status.indexOf("Incomplete") === 0)
                        text: root.report ? root.report.Status + " · coverage " + root.report.Coverage + "/100" : ""
                        color: "#f9e2af"
                    }
                    Label { text: "PICK A CARD. SEE WHAT COUNTS."; font.pixelSize: 10; font.letterSpacing: 1; opacity: 0.6; visible: !!root.report }
                    GridLayout {
                        Layout.fillWidth: true
                        columns: 3
                        columnSpacing: 8
                            ...
                            delegate: Controls.Button {
                                ...
                                contentItem: Column {
                                    ...
                                    ScoreRing {
                                        ...
                                        width: 62; height: 62; stroke: 4; numberSize: 20
                                    ...
                                    Label { anchors.horizontalCenter: parent.horizontalCenter; text: root.names[tile.index]; font.bold: true; font.pixelSize: 12 }
                                }
                            }
                        }
                    }
                    Rectangle {
                        Layout.fillWidth: true
                        implicitHeight: detail.implicitHeight + 26
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Label { Layout.fillWidth: true; text: root.captions[root.selected]; color: root.accents[root.selected]; font.bold: true; font.pixelSize: 16 }
                            ...
                            Label { Layout.fillWidth: true; text: root.rules[root.selected]; font.pixelSize: 12; opacity: 0.7 }
                            Label { Layout.fillWidth: true; visible: !!root.current && !root.current.Known; text: "Some data is missing. This category is not fully assessed."; color: "#f9e2af"; font.pixelSize: 12 }
                        }
                    }
                    Label {
                        Layout.fillWidth: true
                    ...
                    Label { Layout.fillWidth: true; visible: root.errorMessage !== ""; text: root.errorMessage; color: "#f38ba8"; font.pixelSize: 12 }
                    RowLayout {
                        Layout.fillWidth: true
