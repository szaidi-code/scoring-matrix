    ...
    FocusScope {
      ...
      Controls.ScrollView {
        ...
        ColumnLayout {
          ...
          Rectangle {
            Layout.fillWidth: true
            implicitHeight: Math.max(132, hero.implicitHeight + 28)
            radius: 12
          ...
          ColumnLayout {
            ...
            Label { Layout.fillWidth: true; text: root.report ? root.report.Assessment.Detail : ""; font.pixelSize: 12; opacity: 0.8 }
          }
          Label { text: "PICK A CARD. SEE WHAT COUNTS."; font.pixelSize: 10; font.letterSpacing: 1; opacity: 0.6; visible: !!root.report }
          GridLayout {
            id: categoryGrid
            Layout.fillWidth: true
            columns: width < 340 ? 2 : 3
            columnSpacing: 8
            rowSpacing: 8
            visible: !!root.report
            Repeater {
              ...
              delegate: Controls.Button {
                ...
                contentItem: Column {
                  ...
                  Label { anchors.horizontalCenter: parent.horizontalCenter; text: tile.modelData.Known ? "Observed" : "Partial evidence"; font.pixelSize: 10; opacity: 0.7 }
                }
              }
            }
          }
          Rectangle {
            ...
            ColumnLayout {
              ...
              Label { Layout.fillWidth: true; visible: !!root.current && !root.current.Known; text: "Some data is missing. This category is not fully assessed."; color: Color.urgent; font.pixelSize: 12 }
            }
          }
          Label {
            Layout.fillWidth: true
          ...
          Label { Layout.fillWidth: true; visible: root.errorMessage !== ""; text: root.errorMessage; color: Color.urgent; font.pixelSize: 12 }
          RowLayout {
            Layout.fillWidth: true
